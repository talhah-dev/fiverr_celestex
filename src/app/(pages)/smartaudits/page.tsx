...
export default function Smartaudits() {
    ...
    return (
        <Wrapper>
            ...
            <section className=" py-12 sm:py-16">
                <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        <p className="mx-auto mt-2 md:mt-3   max-w-2xl text-[#374151]">
            ...
            <section className="relative overflow-hidden" aria-labelledby="iwa-heading">
                {/* Background */}
                <div className="absolute inset-0 -z-10 bg-gradient-to-b from-sky-50/70 to-white" />

                <div className="mx-auto grid max-w-6xl grid-cols-1 gap-10 items-start px-4 py-12 md:gap-12 md:py-16 lg:grid-cols-2 lg:py-20">
                    {/* Left column */}
                    <div>
                        <h2
                            id="iwa-heading"
                        ...
                        <div className="mt-8">
                            <Link href="/contact">
                                ...
                                >
                                    Request your Intelligent Modern Workplace <span className='md:inline hidden'>Audit</span>
                                </Button>
                            </Link>
                        </div>
                    </div>
                    ...
                    {/* Right column */}
                    <Card className="overflow-hidden rounded-2xl border-0 bg-gradient-to-br from-[#DBEAFE] to-[#CFFAFE] shadow-[0_20px_60px_rgba(2,84,196,0.12)]">
                        <CardContent className="p-6 md:p-8">
                            ...
                            <div className="mx-auto mt-6 grid max-w-md grid-cols-1 gap-4 md:max-w-none md:grid-cols-2">
                                <div className="rounded-xl border border-sky-100 bg-white px-6 py-4 text-center shadow-[0_6px_20px_rgba(2,84,196,0.08)]">
            ...
            <section className="relative overflow-hidden" aria-labelledby="isa-heading">
                {/* Background */}
                <div className="absolute inset-0 -z-10 bg-gradient-to-b from-sky-50/80 to-white" />

                <div className="mx-auto grid max-w-6xl grid-cols-1 gap-10 px-4 py-12 md:gap-12 md:py-16 lg:grid-cols-2 lg:py-20">
                    {/* Left graphic */}
            ...
            >
                <div className="mx-auto max-w-6xl px-4 py-16 md:py-20 text-center">
                    ...
                    <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                        {/* Card 1 */}
                        <div className="rounded-2xl bg-white p-6 shadow-[0_6px_20px_rgba(0,0,0,0.06)] text-left transition-transform hover:-translate-y-1">
                    ...
                    <div className="mt-10 flex justify-center">
                        <Link href="/contact">
                            <Button
                                ...
                                type="button"
                            >
                                Talk to a CelesteIQ consultant<span className='md:inline hidden'>and schedule your free AI diagnosis</span>
                            </Button>
                        </Link>
                    </div>
                </div>
