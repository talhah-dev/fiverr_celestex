...
export default function Contact() {
    ...
    return (
        <Wrapper>
            ...
            <section className="bg-white py-12 sm:py-16">
                <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                        <div>
                            <h2 className="text-4xl md:text-5xl font-semibold tracking-tight text-slate-900">Contact Us</h2>
            ...
            <div className="p-5">
                <div className="rounded-2xl border max-w-5xl mx-auto border-orange-200 bg-orange-50 p-6 sm:p-7 text-slate-900 shadow-sm">
                    <h3 className="text-xl font-semibold">Why Choose CelesteIQ?</h3>
