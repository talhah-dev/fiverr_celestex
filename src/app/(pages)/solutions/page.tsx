        ...
        <>
            <Wrapper>
                    ...
                    <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 text-center">
                        ...
                        <div className="relative rounded-b-[56px] px-4 py-12 sm:py-16 md:py-20 max-w-3xl mx-auto">
                            ...
                            <p className="mx-auto mt-4 max-w-2xl font-semibold text-xl text-white">
                                CelesteIQ helps businesses become more productive, automated, and profitable through seamless integration of Microsoft's ecosystem and AI-driven innovation.
                            </p>
                            <Link href="/contact">
                ...
                <section className=" py-12 sm:py-16">
                    <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="mt-8 grid grid-cols-1 gap-5 md:grid-cols-2">
                            <div className="rounded-2xl bg-white p-6 shadow-[0_18px_40px_rgba(2,6,23,0.06)] ring-1 ring-black/5">
                                <div className="flex items-start gap-4 flex-col">
                                    <span className="grid h-14 w-14 shrink-0 place-items-center rounded-md bg-gradient-to-b from-orange-400 to-[#ea580c] text-white">
                            ...
                            <div className="rounded-2xl bg-white p-6 shadow-[0_18px_40px_rgba(2,6,23,0.06)] ring-1 ring-black/5">
                                <div className="flex items-start gap-4 flex-col">
                                    <span className="grid h-14 w-14 shrink-0 place-items-center rounded-md bg-gradient-to-b from-orange-400 to-[#ea580c] text-white">
                                        <Image src={"/LineChart.svg"} width={28} height={28} className="h-9 w-9" alt="LineChart" />
                                    </span>
                                    <div>
                            ...
                            <div className="rounded-2xl bg-white p-6 shadow-[0_18px_40px_rgba(2,6,23,0.06)] ring-1 ring-black/5">
                                <div className="flex items-start gap-4 flex-col">
                                    <span className="grid h-14 w-14 shrink-0 place-items-center rounded-md bg-gradient-to-b from-orange-400 to-[#ea580c] text-white">
                                        <Image src={"/Servericon.svg"} width={28} height={28} className="h-9 w-9" alt="Icon" />
                                    </span>
                                    <div>
                                        <h3 className="md:text-2xl text-xl font-semibold text-[#0F0F0F]">
                            ...
                            <div className="rounded-2xl bg-white p-6 shadow-[0_18px_40px_rgba(2,6,23,0.06)] ring-1 ring-black/5">
                                <div className="flex items-start gap-4 flex-col">
                                    <span className="grid h-14 w-14 shrink-0 place-items-center rounded-md bg-gradient-to-b from-orange-400 to-[#ea580c] text-white">
                                        <Image src={"/famicons_business-outline-icon.svg"} width={28} height={28} className="h-8 w-8" alt="Icon" />
                                    </span>
                                    <div>
                                        <h3 className="md:text-2xl text-xl font-semibold text-[#0F0F0F]">
                ...
                <section className="py-12 sm:py-16">
                    <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                            <div className="rounded-2xl bg-white p-6 text-center shadow-[0_18px_40px_rgba(2,6,23,0.06)] ring-1 ring-black/5">
                                <span className="mx-auto grid h-14 w-14 place-items-center rounded-md bg-gradient-to-b from-orange-400 to-[#ea580c] text-white">
                            ...
                            <div className="rounded-2xl bg-white p-6 text-center shadow-[0_18px_40px_rgba(2,6,23,0.06)] ring-1 ring-black/5">
                                <span className="mx-auto grid h-14 w-14 place-items-center rounded-md bg-gradient-to-b from-orange-400 to-[#ea580c] text-white">
                                    <Image src={"/chatgpt-icon.svg"} width={28} height={28} className="h-9 w-9" alt="Icon" />
                                </span>
                ...
                <section className=" py-12 sm:py-16">
                    <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                        <div className="text-center">
                            <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold tracking-tight text-slate-900">Industry-Specific Solutions</h2>
                        ...
                        <div className="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                            <div className="rounded-2xl bg-white p-6 shadow-[0_18px_40px_rgba(2,6,23,0.06)] ring-1 ring-black/5">
                                <div className="flex items-start gap-4 flex-col">
                                    <span className="grid h-14 w-14 place-items-center rounded-md bg-gradient-to-b from-orange-400 to-[#ea580c] text-white"><Landmark className="h-7 w-7" /></span>
                                    <div>
                                        <p className="font-semibold text-slate-900 text-lg">Finance & Insurance</p>
                                        <p className="mt-1 text-slate-600">Secure, compliant, and intelligent solutions for financial services.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl bg-white p-6 shadow-[0_18px_40px_rgba(2,6,23,0.06)] ring-1 ring-black/5">
                                <div className="flex items-start gap-4 flex-col">
                                    <span className="grid h-14 w-14 place-items-center rounded-md bg-gradient-to-b from-orange-400 to-[#ea580c] text-white"><HeartPulse className="h-7 w-7" /></span>
                                    <div>
                                        <p className="font-semibold text-slate-900 text-lg">Healthcare & Wellness</p>
                                        <p className="mt-1 text-slate-600">HIPAA-compliant systems with AI-powered patient care.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl bg-white p-6 shadow-[0_18px_40px_rgba(2,6,23,0.06)] ring-1 ring-black/5">
                                <div className="flex items-start gap-4 flex-col">
                                    <span className="grid h-14 w-14 place-items-center rounded-md bg-gradient-to-b from-orange-400 to-[#ea580c] text-white">
                                        <Image src={"/manufacture-icon.svg"} width={28} height={28} className="h-8 w-8" alt="LineChart" />
                                    </span>
                                    <div>
                                        <p className="font-semibold text-slate-900 text-lg">Manufacturing & Real Estate</p>
                                        <p className="mt-1 text-slate-600">Optimize operations and enhance productivity with smart automation.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
