            ...
            <section className=" py-12 sm:py-16">
                <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:mt-16 mt-8 md:grid-cols-2 md:gap-8 gap-4 grid-cols-1">
                        ...
                        <div className="overflow-hidden rounded-3xl bg-white shadow-[0_24px_60px_rgba(2,6,23,0.08)] ring-1 ring-black/5">
                            <div className="relative w-full sm:h-96">
                                <Image src="/blog1.png" alt="Featured post" width={500} height={300}  className="object-cover w-full sm:h-96" />
                            ...
                            <div className="p-4 sm:p-6">
                                ...
                                <h3 className="mt-2 text-xl font-medium text-slate-900">The Future of AI in Business: 5 Trends to Watch in 2025</h3>
                    ...
                    <div className="flex items-center justify-center mt-10">
                        <Button className='py-6 bg-[#FF7A00] rounded-full text-white hover:bg-orange-600' size={"lg"}>Explore Articles
